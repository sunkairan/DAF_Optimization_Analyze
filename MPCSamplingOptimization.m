function fx = MPCSamplingOptimization(target, T, W, dt, curASP, s)
...
[ffx, fval] = fmincon(@(x)MPCFunctionToBeOpt(x,target,T,W,s,sWindowSum,curASP),fx0,A,b,Aeq,beq,lb,ub);
