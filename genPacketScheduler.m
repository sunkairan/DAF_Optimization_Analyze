...
% for slope-only opt scheme.
% Need to pre-load the 'FO_OptResult_**.mat' file:
%   Must have s, T, W, dt (UN-downscaled); 
%   and resulting prob.s: fx (vector of slopes). 
% load('FO_OptResult_T300_W20_dt1_foreman');
% Output 'foreman_W20_dt1_P1024_dummy/info/scheduler.txt'
...
seqName_W_dt = [seqName, '_W', int2str(WW), '_dt',int2str(dt), '_P',int2str(P)];
